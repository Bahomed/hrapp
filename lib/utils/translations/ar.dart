const Map<String, String> arTranslations = {
  ...
  'create_loan_request': 'إنشاء طلب سلفة',
  ...
  'edit_loan_request': 'تعديل طلب السلفة',
  ...
  'edit_loan_request_description': 'تعديل تفاصيل طلب السلفة',
  ...
  'deduction_start_date': 'تاريخ بداية خصم السلفة',
  ...
  // Submit Buttons
  'submit_loan_request': 'إرسال طلب السلفة',
  ...
  'update_loan_request': 'تحديث طلب السلفة',
  ...
  "failed_to_delete_loan_request": "فشل حذف طلب السلفة: %s",
  "error_deleting_loan_request": "خطأ في حذف طلب السلفة: %s",
  ...
  "failed_to_create_loan_request": "فشل إنشاء طلب سلفة: %s",
  "error_creating_loan_request": "خطأ في إنشاء طلب سلفة: %s",
  "loan_request_created_successfully": "تم إنشاء طلب السلفة بنجاح",
  ...
  "failed_to_update_loan_request": "فشل تحديث طلب السلفة: %s",
  "error_updating_loan_request": "خطأ في تحديث طلب السلفة: %s",
  "loan_request_updated_successfully": "تم تحديث طلب السلفة بنجاح",
  ...
  "error_updating_leave_request": "خطا في تحديث طلب السلفة: %s",
...
'to':'إلى',
  ...
  'missing_punch': 'بصمة مفقودة',
  'missing_punch_request': 'طلب بصمة مفقودة',
  'missing_punch_request_description': 'الإبلاغ عن تسجيل حضور أو انصراف مفقود',
  'create_missing_punch_request': 'إنشاء طلب بصمة مفقودة',
  'edit_missing_punch_request': 'تعديل طلب بصمة مفقودة',
  'submit_missing_punch_request': 'إرسال طلب البصمة المفقودة',
  'update_missing_punch_request': 'تحديث طلب البصمة المفقودة',
  'no_missing_punch_requests': 'لا توجد طلبات بصمة مفقودة',
  'no_missing_punch_requests_subtitle': 'لم تقدم أي طلبات بصمة مفقودة بعد',
  'check_in': 'تسجيل الحضور',
  'check_out': 'تسجيل الانصراف',
  'missing_punch_request_created_successfully': 'تم إنشاء طلب البصمة المفقودة بنجاح',
  'missing_punch_request_updated_successfully': 'تم تحديث طلب البصمة المفقودة بنجاح',
  'missing_punch_request_deleted_successfully': 'تم حذف طلب البصمة المفقودة بنجاح',
  'confirm_delete_missing_punch_request': 'هل أنت متأكد من حذف طلب البصمة المفقودة؟',
  'failed_to_load_missing_punch_requests': 'فشل تحميل طلبات البصمة المفقودة',
  'error_loading_missing_punch_requests': 'خطأ في تحميل طلبات البصمة المفقودة',
  'failed_to_load_more_missing_punch_requests': 'فشل تحميل المزيد من طلبات البصمة المفقودة',
  'error_loading_more_missing_punch_requests': 'خطأ في تحميل المزيد من طلبات البصمة المفقودة',
  'failed_to_create_missing_punch_request': 'فشل إنشاء طلب البصمة المفقودة',
  'error_creating_missing_punch_request': 'خطأ في إنشاء طلب البصمة المفقودة',
  'failed_to_update_missing_punch_request': 'فشل تحديث طلب البصمة المفقودة',
  'error_updating_missing_punch_request': 'خطأ في تحديث طلب البصمة المفقودة',
};