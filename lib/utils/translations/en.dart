const Map<String, String> enTranslations = {
  ...
  'generated': 'Generated',
  'executed': 'Granted',
  'executed_amount': 'Granted Amount',
  'executed_installments': 'Granted Installment',
...
'penalty':'Penalty',
  ...
  'failed_to_load_document_types':'Failed to load document types',
  'error_loading_document_types':'Error loading document types',
  ...
  'notif_req_letter': 'Letter',
  'notif_req_overtime': 'Overtime',
  'notif_req_missingpunch': 'Missing Punch',
  ...
  'overtime_request_description': 'Request overtime hours compensation',
  ...
  'no_overtime_requests_subtitle': 'You have no overtime requests yet',
  'please_select_from_date': 'Please select from date',
  'please_select_to_date': 'Please select to date',
  'please_enter_ot_hours': 'Please enter overtime hours',
  'please_enter_valid_hours': 'Please enter a valid number of hours',
  'overtime_request_created_successfully': 'Overtime request created successfully',
  'overtime_request_updated_successfully': 'Overtime request updated successfully',
  'overtime_request_deleted_successfully': 'Overtime request deleted successfully',
  'delete_overtime_request': 'Delete Overtime Request',
  'confirm_delete_overtime_request': 'Are you sure you want to delete this overtime request?',
  'failed_to_load_overtime_requests': 'Failed to load overtime requests',
  'error_loading_overtime_requests': 'Error loading overtime requests',
  'failed_to_load_more_overtime_requests': 'Failed to load more overtime requests',
  'error_loading_more_overtime_requests': 'Error loading more overtime requests',
  'failed_to_create_overtime_request': 'Failed to create overtime request',
  'error_creating_overtime_request': 'Error creating overtime request',
  'failed_to_update_overtime_request': 'Failed to update overtime request',
  'error_updating_overtime_request': 'Error updating overtime request',
  'failed_to_delete_overtime_request': 'Failed to delete overtime request',
  'error_deleting_overtime_request': 'Error deleting overtime request',
  ...
  'condition_at_assign': 'Condition at Assign',
  ...
  'missing_punch_request': 'Missing Punch Request',
  'missing_punch_request_description': 'Report a missing check-in or check-out',
  'create_missing_punch_request': 'Create Missing Punch Request',
  'edit_missing_punch_request': 'Edit Missing Punch Request',
  'submit_missing_punch_request': 'Submit Missing Punch Request',
  'update_missing_punch_request': 'Update Missing Punch Request',
  'no_missing_punch_requests': 'No Missing Punch Requests',
  'no_missing_punch_requests_subtitle': 'You have no missing punch requests yet',
  'check_in': 'Check In',
  'check_out': 'Check Out',
  'missing_punch_request_created_successfully': 'Missing punch request created successfully',
  'missing_punch_request_updated_successfully': 'Missing punch request updated successfully',
  'missing_punch_request_deleted_successfully': 'Missing punch request deleted successfully',
  'confirm_delete_missing_punch_request': 'Are you sure you want to delete this missing punch request?',
  'failed_to_load_missing_punch_requests': 'Failed to load missing punch requests',
  'error_loading_missing_punch_requests': 'Error loading missing punch requests',
  'failed_to_load_more_missing_punch_requests': 'Failed to load more missing punch requests',
  'error_loading_more_missing_punch_requests': 'Error loading more missing punch requests',
  'failed_to_create_missing_punch_request': 'Failed to create missing punch request',
  'error_creating_missing_punch_request': 'Error creating missing punch request',
  'failed_to_update_missing_punch_request': 'Failed to update missing punch request',
  'error_updating_missing_punch_request': 'Error updating missing punch request',
};