// File: lib/view/request_leave/create_request/edit_letter_request_screen.dart
...
class EditLetterRequestScreen extends StatelessWidget {
  final LetterRequest request;
  
  const EditLetterRequestScreen({super.key, required this.request});
  ...
  Widget build(BuildContext context) {
    ...
    // Find and set the current letter type from the dropdown options
    WidgetsBinding.instance.addPostFrameCallback((_) {
      final currentType = controller.letterTypes.cast<RequestTypeOption?>().firstWhere(
        (type) => type?.name == request.letterType,
        orElse: () => null,
      );
      selectedLetterType.value = currentType;
    });
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            tr('edit_letter_request_description'),
                            style: TextStyle(
                              fontSize: 14,
                ...
                child: ElevatedButton(
                  onPressed: controller.isLoading.value
                    ...
                    if (formKey.currentState!.validate() && selectedLetterType.value != null) {
                      final success = await controller.updateLetterRequestWithData(
                        id: request.id,
